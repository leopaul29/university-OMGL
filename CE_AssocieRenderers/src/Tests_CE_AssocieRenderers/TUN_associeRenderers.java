...
public class TUN_associeRenderers {
	...
	public static void main(String[] args) {
		...
		Ecran e3 = new Ecran("ecran3", dim_ecran1, g);
		Ecran e4 = new Ecran("ecran4", dim_ecran2, g);
		...
		Tests.Design("Controle des écrans", 3); {
			...
			Tests.Case("Afficher un écran");{
				...
				// Ecran 2
				//
				String test_e2 = "Ecran [ nom = ecran2, dimension = Dimension [ height = 600.0, width = 600.0 ], "
						// Afficheur 2 associé à l'écran 2
						+ "afficheur = Afficheur afficheur 2 [ Dimension [ height = 600.0, width = 600.0 ], Style Noel, "
						+ "Liste de Zones : {"
						// Renderer  1 associé à l'afficheur 2 !
						+ "paysage=Zone Bloc : paysage [ Dimension [ height = 200.0, width = 400.0 ], "
				...
				// Ecran 3
				//
				String test_e3 = "Ecran [ nom = ecran3, dimension = Dimension [ height = 800.0, width = 800.0 ], "
						// Pas d'afficheur associé
						+ "afficheur = null ]";
				...
				// Ecran 4
				//
				String test_e4 = "Ecran [ nom = ecran4, dimension = Dimension [ height = 600.0, width = 600.0 ], "
						// Afficheur 2 associé à l'écran 4
						+ "afficheur = Afficheur afficheur 2 [ Dimension [ height = 600.0, width = 600.0 ], Style Noel, "
			...
			Tests.Case("Afficher le gestionnaire");{
				...
				String test_gE = "["
						// Pas d'afficheur associé
						+ "Ecran [ nom = ecran1, dimension = Dimension [ height = 800.0, width = 800.0 ], afficheur = null ], "
						
						+ "Ecran [ nom = ecran2, dimension = Dimension [ height = 600.0, width = 600.0 ], "
						// Afficheur 2 associé à l'écran 2
						+ "afficheur = Afficheur afficheur 2 [ Dimension [ height = 600.0, width = 600.0 ], Style Noel, "
						+ "Liste de Zones : {paysage=Zone Bloc : paysage [ Dimension [ height = 200.0, width = 400.0 ], "
						// Renderer  1 associé à l'afficheur 2 !
						...
						// Pas d'afficheur associé
						+ "Ecran [ nom = ecran3, dimension = Dimension [ height = 800.0, width = 800.0 ], afficheur = null ], "
						
						+ "Ecran [ nom = ecran4, dimension = Dimension [ height = 600.0, width = 600.0 ], "
						// Afficheur 2 associé à l'écran 4
						+ "afficheur = Afficheur afficheur 2 [ Dimension [ height = 600.0, width = 600.0 ], Style Noel, "
						+ "Liste de Zones : {paysage=Zone Bloc : paysage [ Dimension [ height = 200.0, width = 400.0 ], "
						// Renderer  1 associé à l'afficheur 2 !
