...
class Calendrier extends JPanel implements ActionListener{ 
	...
	JPanel container; 
    Vector<JButton> btnVect = new Vector<JButton>(); 
    SButton suiv; 
    SButton prec; 
    JFrame createur;
     
    int x0,y0,mois,annee;//pour setLocation 
     
    Calendrier(int x0,int y0,int iMois,JPanel container, JFrame createur){ 
        super(); 
        ...
        new SLabel(string(iMois)+" "+2013,1,14,150,0,120,30,this); 
            ...
            while( colonne<7){ 
                ...
                btn.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						System.out.println("Date Sélectionner sur le calendrier");
						createur.dispose();
					}
				});
