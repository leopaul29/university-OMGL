package Tests;
//
// Annee 2011_2012 - Module Java - Charte tests unitaires
//
 ...
 * unitaires.
 * 
 * @param name    Nom du module de tests.
 * @param version Version du test.
 * 
 */
 ...
 * design".
 * 
 * @param name       Nom du test design.
 * @param level      Niveau du test.
 * @param designName Nom du test.
 * 
**/
 ...
 * 
 * @param name  Nom du test case.
 * @param level Niveau du test case.
 */
...
* design" courant. 
* 
 * @param attendu Valeur de l'objet attendu.
 * @param obtenu  Valeur de l'objet obtenue.
*
**/
...
public static void Unit(Object attendu, Object obtenu)
{
   ...
   if ((obtenu == null && attendu != null) || (obtenu != null && attendu == null) || !obtenu.equals(attendu))
...
/**
 * Test unit pour deux variables de types int.
 * 
...
/**
 * Tests unit pour deux double avec précision.
 * 
 * @param attendu Valeur attendue.
 * @param obtenu  Valeur obtenue.
 * @param epsilon Epsilon de précision.
 */
...
*/
/**
 * Test unit pour 2 tableaux d'objets.
 * 
 * @param attendus Tableau d'objets attendu.
 * @param obtenu   Tableau obtenu.
 */
public static void Unit(Object[] attendus, Object obtenu)
{
   ...
   // Traiter le cas particulier d'un tableau vide
   //
   ...
   else
   {
      ...
      // Parcourir le tableau des valeurs attendues
      //
      for (int i = 0; i < attendus.length; i++)
      {

         // Traiter le cas particulier d'une valeur nulle
         //
         if (obtenu == null && attendus[i] == null)
            return;
         if (obtenu == null && attendus[i] != null)
            continue;
