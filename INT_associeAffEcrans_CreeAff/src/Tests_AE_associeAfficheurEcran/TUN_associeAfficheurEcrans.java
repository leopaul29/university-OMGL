	...
	public static void main(String[] args) {
		...
		Tests.Design("Controle des dimensions", 3); {
			...
			Tests.Case("Afficher la dimension des écrans"); {
				...
				Tests.Unit("Dimension [ height = 800.0, width = 1180.0 ]", e2.afficherDimension());
				Tests.Unit("Dimension [ height = 768.0, width = 1366.0 ]", e3.afficherDimension());
				Tests.Unit("Dimension [ height = 800.0, width = 800.0 ]", e4.afficherDimension());
				Tests.Unit("Dimension [ height = 800.0, width = 1180.0 ]", e5.afficherDimension());
			}
			...
			Tests.Case("Afficher la dimension des afficheurs"); {
				...
				Tests.Unit("Dimension [ height = 800.0, width = 1180.0 ]", a2.afficherDimensionA());
				Tests.Unit("Dimension [ height = 768.0, width = 1366.0 ]", a3.afficherDimensionA());
				Tests.Unit("Dimension [ height = 800.0, width = 1180.0 ]", a4.afficherDimensionA());
			...
			Tests.Case("Afficher la dimension des écran auquel ils sont attribués"); {
				...
				Tests.Unit("Dimension [ height = 800.0, width = 1180.0 ]", a2.afficherDimensionE());
				Tests.Unit("Dimension [ height = 768.0, width = 1366.0 ]", a3.afficherDimensionE());
				Tests.Unit("Dimension [ height = 768.0, width = 1366.0 ]", a4.afficherDimensionE());
				Tests.Unit("Dimension [ height = 768.0, width = 1366.0 ]", a5.afficherDimensionE());
			}
		...
		Tests.Design("Controle des afficheurs par le nom d'afficheur", 3); {
			...
			Tests.Case("Contenu du stock d'afficheur");{
				...
				String test_listAff = 
						...
						+ "Liste de Zones : {zone 4=Zone Text : zone 4 [ Dimension [ height = 500.0, width = 100.0 ], vide ], "
						...
						+ "Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 768.0, width = 180.0 ], vide ], "
						+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
						+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
						+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ], "
						...
						+ "Liste de Zones : {zone 5=Zone Text : zone 5 [ Dimension [ height = 768.0, width = 366.0 ], vide ], "
						+ "zone 4=Zone Text : zone 4 [ Dimension [ height = 500.0, width = 100.0 ], vide ], "
						+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
						+ "Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 500.0, width = 500.0 ], URGENT ], "
						+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ]} ], "
						...
						// Afficheur 4
						//
						+ "afficheur 4=Afficheur afficheur 4 [ Dimension [ height = 800.0, width = 1180.0 ], Style IUT Fabron, "
						+ "Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 768.0, width = 180.0 ], vide ], "
						+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
						+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
						+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ], "
			...
			Tests.Design("Controle des afficheur par le nom d'auteur", 3); {
				...
				Tests.Case("Afficheur par nom auteur");{
					...
					String test_affparLeo = "Auteur : leo [ "
							...
							// Afficheur 4
							//
							+ "Afficheur afficheur 4 [ Dimension [ height = 800.0, width = 1180.0 ], Style IUT Fabron, "
							+ "Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 768.0, width = 180.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
							+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ]"
					...
					String test_affparCorentin = "Auteur : corentin [ "
							+ "Afficheur afficheur 2 [ Dimension [ height = 800.0, width = 1180.0 ], Style Basic, "
							+ "Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 768.0, width = 180.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
							+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ] ]";
					...
					String test_affparCoraline = "Auteur : coraline [ "
							+ "Afficheur afficheur 3 [ Dimension [ height = 768.0, width = 1366.0 ], Style Festival de Cannes, "
							+ "Liste de Zones : {zone 5=Zone Text : zone 5 [ Dimension [ height = 768.0, width = 366.0 ], vide ], "
							+ "zone 4=Zone Text : zone 4 [ Dimension [ height = 500.0, width = 100.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							+ "Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 500.0, width = 500.0 ], URGENT ], "
			...
			Tests.Design("Controle des écrans", 3); {
				...
				Tests.Case("Afficher un écran");{
					...
					// Ecran 2
					//
					String test_e2 = "Ecran [ nom = ecran2, dimension = Dimension [ height = 800.0, width = 1180.0 ], "
							+ "afficheur = Afficheur afficheur 2 [ Dimension [ height = 800.0, width = 1180.0 ], Style Basic, "
							+ "Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 768.0, width = 180.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
							+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ] ]";
					...
					// Ecran 3
					//
					String test_e3 = "Ecran [ nom = ecran3, dimension = Dimension [ height = 768.0, width = 1366.0 ], "
							+ "afficheur = Afficheur afficheur 3 [ Dimension [ height = 768.0, width = 1366.0 ], Style Festival de Cannes, "
							+ "Liste de Zones : {zone 5=Zone Text : zone 5 [ Dimension [ height = 768.0, width = 366.0 ], vide ], "
							+ "zone 4=Zone Text : zone 4 [ Dimension [ height = 500.0, width = 100.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							+ "Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 500.0, width = 500.0 ], URGENT ], "
					...
					// Ecran 5
					//
					String test_e5 = "Ecran [ nom = ecran5, dimension = Dimension [ height = 800.0, width = 1180.0 ], "
							+ "afficheur = Afficheur afficheur 2 [ Dimension [ height = 800.0, width = 1180.0 ], Style Basic, "
							+ "Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 768.0, width = 180.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
				...
				Tests.Case("Afficher le gestionnaire");{
					...
					String test_gE = "[Ecran "
							...
							// Ecran 2
							//
							+ "Ecran [ nom = ecran2, dimension = Dimension [ height = 800.0, width = 1180.0 ], "
							+ "afficheur = Afficheur afficheur 2 [ Dimension [ height = 800.0, width = 1180.0 ], Style Basic, "
							+ "Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 768.0, width = 180.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
							...
							// Ecran 3
							//
							+ "Ecran [ nom = ecran3, dimension = Dimension [ height = 768.0, width = 1366.0 ], "
							+ "afficheur = Afficheur afficheur 3 [ Dimension [ height = 768.0, width = 1366.0 ], Style Festival de Cannes, "
							+ "Liste de Zones : {zone 5=Zone Text : zone 5 [ Dimension [ height = 768.0, width = 366.0 ], vide ], "
							+ "zone 4=Zone Text : zone 4 [ Dimension [ height = 500.0, width = 100.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							...
							// Ecran 5
							//
							+ "Ecran [ nom = ecran5, dimension = Dimension [ height = 800.0, width = 1180.0 ], "
							+ "afficheur = Afficheur afficheur 2 [ Dimension [ height = 800.0, width = 1180.0 ], Style Basic, "
							+ "Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 768.0, width = 180.0 ], vide ], "
							+ "paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
							+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
