	...
	public static void main(String[] args) {
		...
		Tests.Design("Controle de l'afficheur", 3); {
			...
			Tests.Case("Méthode toString"); {
				...
				//
				String test_toS_a1 = "Afficheur afficheur 1 [ Dimension [ height = 800.0, width = 200.0 ], Style Basic, "
				...
				String test_toS_a2 = "Afficheur afficheur 2 [ Dimension [ height = 800.0, width = 1000.0 ], Style Basic, "
				...
				String test_toS_a3 = "Afficheur afficheur 3 [ Dimension [ height = 800.0, width = 1000.0 ], Style Festival de Cannes, "
						+ "Liste de Zones : {paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
						+ "Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 800.0, width = 200.0 ], URGENT ], "
						+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
						+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ]";
		...
		Tests.Design("Controle du Stock_style", 3); {
			...
			Tests.Case("Méthode toString"); {
				...
				String test_toS_LA = 
						// Afficheur 1
						//
						"{afficheur 1=Afficheur afficheur 1 [ Dimension [ height = 800.0, width = 1000.0 ], Style IUT Fabron, "
						+ "Liste de Zones : {Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 800.0, width = 200.0 ], URGENT ], "
						+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ], "
						
						// Afficheur 2
						//
						+ "afficheur 2=Afficheur afficheur 2 [ Dimension [ height = 800.0, width = 1000.0 ], Style Basic, "
						+ "Liste de Zones : {paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
						+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
						+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ], "
						...
						// Afficheur 3
						//
						+ "afficheur 3=Afficheur afficheur 3 [ Dimension [ height = 800.0, width = 1000.0 ], Style Festival de Cannes, "
						+ "Liste de Zones : {paysage=Zone Bloc : paysage [ Dimension [ height = 600.0, width = 300.0 ], chemin d'image ], "
						+ "Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 800.0, width = 200.0 ], URGENT ], "
						+ "zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], "
						+ "diaporama=Zone Bloc : diaporama [ Dimension [ height = 800.0, width = 200.0 ], chemin dossierImages ]} ]}";
