	...
	public static void main(String[] args) {
		...
		Tests.Design("AS_ConOrganiseEcrans - Accesseur", 3); {
			...
			Tests.Case("Accesseur de consultation d'un écran", 3); {
				...
				//
				Tests.Unit("e1", e1.getNom());

				// Afficher le site de l'écran "e4"
				//
				String test_getSite = "[ nom = Sophia, localisation = quelquepart, "
				...
				//
				Tests.Unit("couloir 7**", e3.getPosition());
			}
			...
			Tests.Case("Accesseur de consultation d'un site", 3); {
				...
				//
				String test_getListe_Ecrans = "[[ nom = e1, site = Fabron, position = hall d'entrée, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ], "
			...
			Tests.Case("Accesseur de consultation du gestionnaire"); {
				...
				//
				String test_getListe_site = "[[ nom = Fabron, localisation = route Napoleon, "
		...
		Tests.Design("AS_ConOrganiseEcrans - Méthode toString", 3); {
			...
			Tests.Case("Méthode toString de l'écran", 3); {
				...
				//
				String test_e1_toString = "[ nom = e1, site = Fabron, position = hall d'entrée, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]";
				Tests.Unit(test_e1_toString, e1.toString());

				// Afficher le statut complet de l'écran "e2"
				//
				String test_e2_toString = "[ nom = e2, site = Fabron, position = premier etage, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]";
				Tests.Unit(test_e2_toString, e2.toString());

				// Afficher le statut complet de l'écran "e3"
				//
				String test_e3_toString = "[ nom = e3, site = Fabron, position = couloir 7**, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]";
				Tests.Unit(test_e3_toString, e3.toString());

				// Afficher le statut complet de l'écran "e4"
				//
				String test_e4_toString = "[ nom = e4, site = Sophia, position = Entrée batiment B, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]";
			...
			Tests.Design("AS_ConOrganiseEcrans - Changer de site un écran", 3); {
				...
				Tests.Case("Avant le déplacement de l'écran 'e4'"); {
					...
					//
					String test_s2_avantDeplace = "[[ nom = e4, site = Sophia, position = Entrée batiment B, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]]";
					Tests.Unit(test_s2_avantDeplace, s2.getListe_Ecrans().toString());

					// Contenue du site "s1" avant le deplacement
					//
					String test_s1_apresDeplace = "[[ nom = e1, site = Fabron, position = hall d'entrée, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ], "
							+ "[ nom = e2, site = Fabron, position = premier etage, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ], "
							+ "[ nom = e3, site = Fabron, position = couloir 7**, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]]";
				...
				Tests.Case("Déplacer l'écran 'e4'"); {
					...
					//
					Tests.Unit(false, g.deplacerEcran(e3, s1));
				...
				Tests.Case("Apres le déplacement de l'écran 'e4'"); {
					...
					String test_s1_apresDeplace = "[[ nom = e1, site = Fabron, position = hall d'entrée, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ], "
							+ "[ nom = e2, site = Fabron, position = premier etage, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ], "
							+ "[ nom = e3, site = Fabron, position = couloir 7**, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ], "
							// Ecran "e4" ajouter au site "s1"
							//
							+ "[ nom = e4, site = Fabron, position = null, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]]";
					Tests.Unit(test_s1_apresDeplace, s1.getListe_Ecrans().toString());
				}
			}
			...
			Tests.Design("AS_ConOrganiseEcrans - Effacer un site", 3); {
				...
				Tests.Case("Avant d'éffacer les site 's2' et 's3'"); {
					...
					//
					String test_contenuS2 = "[[ nom = e2, site = Sophia, position = null, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]]";
					Tests.Unit(test_contenuS2, s2.getListe_Ecrans().toString());

					// Verifier que les sites "s2" et "s3" appartiennent au gestionnaire
					//
					String test_gToString = "Gestionnaire [ Site = [["

							// Site "s1" possede 3 ecran
							//
							+ "[ nom = Fabron, localisation = route Napoleon, écrans = ["
							+ "[ nom = e1, site = Fabron, position = hall d'entrée, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ], "
							+ "[ nom = e3, site = Fabron, position = couloir 7**, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ], "
							+ "[ nom = e4, site = Fabron, position = null, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]] ], "

						// Site "s2" possede 1 ecran
						//
						+ "[ nom = Sophia, localisation = quelquepart, écrans = ["
						+ "[ nom = e2, site = Sophia, position = null, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]] ], "

						// Site "s3" possede 0 ecran
						//
						+ "[ nom = Antibes, localisation = ailleur, écrans = [] ]]] ]";
				...
				Tests.Case("Effacer le site 's3'"); {
					...
					//
					String test_gToString2 = "Gestionnaire [ Site = [["
				...
				Tests.Case("Effacer le site 's2'"); {
					...
					//
					String test_gToString3 = "Gestionnaire [ Site = [["
					...
					//
					String test_contenuR = "[[ nom = e2, site = Reserve, position = null, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne ]]";
