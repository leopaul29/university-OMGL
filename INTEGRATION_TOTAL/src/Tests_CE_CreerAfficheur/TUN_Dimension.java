	...
	public static void main(String[] args) {
		...
		Tests.Design("Class Dimension", 3); {
			...
			Tests.Case("Méthode toString"); {
				...
				//
				Tests.Unit("Dimension [ height = 1300.0, width = 800.0 ]", dim_e1.toString());

				Tests.Unit("Dimension [ height = 1366.0, width = 768.0 ]", dim_a1.toString());

				Tests.Unit("Dimension [ height = 1600.0, width = 1200.0 ]", dim_a2.toString());
			}
		}
