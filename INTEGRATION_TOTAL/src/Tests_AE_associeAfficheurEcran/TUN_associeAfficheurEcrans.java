...
public class TUN_associeAfficheurEcrans {
	...
	public static void main(String[] args) {
		...
		Ecran e3 = new Ecran(site1, "couloir 7**", "ecran3", dim_ecran3, g);
		Ecran e4 = new Ecran(site2, "Entrée batiment B", "ecran4", dim_ecran1, a4, g);
		Ecran e5 = new Ecran(site2, "Entrée batiment A","ecran5", dim_ecran2, a5, g);
		...
		Tests.Design("Controle des afficheurs par le nom d'afficheur", 3); {
			...
			Tests.Design("Controle des écrans", 3); {
				...
				Tests.Case("Afficher un écran");{
					...
					// Ecran 1
					//
					String test_e1 = "[ nom = ecran1, site = Fabron, position = hall d'entrée, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne, dimension = Dimension [ height = 800.0, width = 800.0 ], afficheur = Afficheur afficheur 1 [ Dimension [ height = 800.0, width = 800.0 ], Style Basic, Liste de Zones : {zone 4=Zone Text : zone 4 [ Dimension [ height = 100.0, width = 500.0 ], vide ], Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 500.0, width = 500.0 ], URGENT ], zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], diaporama=Zone Bloc : diaporama [ Dimension [ height = 200.0, width = 800.0 ], chemin dossierImages ]} ] ]";
					...
					// Ecran 2
					//
					String test_e2 = "[ nom = ecran2, site = Fabron, position = premier etage, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne, dimension = Dimension [ height = 1180.0, width = 800.0 ], afficheur = Afficheur afficheur 2 [ Dimension [ height = 1180.0, width = 800.0 ], Style Basic, Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 180.0, width = 768.0 ], vide ], paysage=Zone Bloc : paysage [ Dimension [ height = 300.0, width = 600.0 ], chemin d'image ], zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], diaporama=Zone Bloc : diaporama [ Dimension [ height = 200.0, width = 800.0 ], chemin dossierImages ]} ] ]";
					...
					// Ecran 3
					//
					String test_e3 = "[ nom = ecran3, site = Fabron, position = couloir 7**, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne, dimension = Dimension [ height = 1366.0, width = 768.0 ], afficheur = Afficheur afficheur 3 [ Dimension [ height = 1366.0, width = 768.0 ], Style Festival de Cannes, Liste de Zones : {zone 5=Zone Text : zone 5 [ Dimension [ height = 366.0, width = 768.0 ], vide ], zone 4=Zone Text : zone 4 [ Dimension [ height = 100.0, width = 500.0 ], vide ], paysage=Zone Bloc : paysage [ Dimension [ height = 300.0, width = 600.0 ], chemin d'image ], Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 500.0, width = 500.0 ], URGENT ], zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ]} ] ]";
				...
				Tests.Case("Afficher le gestionnaire");{
					...
					//
					String test_gE = "[[ nom = ecran1, site = Fabron, position = hall d'entrée, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne, dimension = Dimension [ height = 800.0, width = 800.0 ], afficheur = Afficheur afficheur 1 [ Dimension [ height = 800.0, width = 800.0 ], Style Basic, Liste de Zones : {zone 4=Zone Text : zone 4 [ Dimension [ height = 100.0, width = 500.0 ], vide ], Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 500.0, width = 500.0 ], URGENT ], zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], diaporama=Zone Bloc : diaporama [ Dimension [ height = 200.0, width = 800.0 ], chemin dossierImages ]} ] ], [ nom = ecran2, site = Fabron, position = premier etage, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne, dimension = Dimension [ height = 1180.0, width = 800.0 ], afficheur = Afficheur afficheur 2 [ Dimension [ height = 1180.0, width = 800.0 ], Style Basic, Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 180.0, width = 768.0 ], vide ], paysage=Zone Bloc : paysage [ Dimension [ height = 300.0, width = 600.0 ], chemin d'image ], zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], diaporama=Zone Bloc : diaporama [ Dimension [ height = 200.0, width = 800.0 ], chemin dossierImages ]} ] ], [ nom = ecran3, site = Fabron, position = couloir 7**, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne, dimension = Dimension [ height = 1366.0, width = 768.0 ], afficheur = Afficheur afficheur 3 [ Dimension [ height = 1366.0, width = 768.0 ], Style Festival de Cannes, Liste de Zones : {zone 5=Zone Text : zone 5 [ Dimension [ height = 366.0, width = 768.0 ], vide ], zone 4=Zone Text : zone 4 [ Dimension [ height = 100.0, width = 500.0 ], vide ], paysage=Zone Bloc : paysage [ Dimension [ height = 300.0, width = 600.0 ], chemin d'image ], Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 500.0, width = 500.0 ], URGENT ], zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ]} ] ], [ nom = ecran4, site = Sophia, position = Entrée batiment B, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne, dimension = Dimension [ height = 800.0, width = 800.0 ], afficheur = Afficheur afficheur 1 [ Dimension [ height = 800.0, width = 800.0 ], Style Basic, Liste de Zones : {zone 4=Zone Text : zone 4 [ Dimension [ height = 100.0, width = 500.0 ], vide ], Alerte rouge=Zone TextAlerte : Alerte rouge [ Dimension [ height = 500.0, width = 500.0 ], URGENT ], zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], diaporama=Zone Bloc : diaporama [ Dimension [ height = 200.0, width = 800.0 ], chemin dossierImages ]} ] ], [ nom = ecran5, site = Sophia, position = Entrée batiment A, état = en marche, erreurs levées = [], éteint = false, éteint par = Personne, dimension = Dimension [ height = 1180.0, width = 800.0 ], afficheur = Afficheur afficheur 2 [ Dimension [ height = 1180.0, width = 800.0 ], Style Basic, Liste de Zones : {zone 6=Zone Bloc : zone 6 [ Dimension [ height = 180.0, width = 768.0 ], vide ], paysage=Zone Bloc : paysage [ Dimension [ height = 300.0, width = 600.0 ], chemin d'image ], zone 1=Zone Text : zone 1 [ Dimension [ height = 500.0, width = 500.0 ], texte d'information ], diaporama=Zone Bloc : diaporama [ Dimension [ height = 200.0, width = 800.0 ], chemin dossierImages ]} ] ]]";
